...
// 199. An AI has infected a text with a character!!
//
...
//     if(left >= call && left < right) return 'left'
//     if(left <= call && left > right) return 'left'
//     else return 'right'
// }
...
//     if(s.includes('tree fiddy') || s.includes('three fifty') || s.includes('3.50') ) return true
//     else return false
// }
...
// 204. Complete the function, which calculates how much you need to tip based on the total amount of the bill and the service.
//
...
// 207.
//
// ou will be given an array of numbers which can be used using the String.fromCharCode() (JS), Tools.FromCharCode() (C#) method to convert the number to a character. It is recommended to map over the array of numbers and convert each number to the corresponding ascii character.
//
...
// 209. You and a friend have decided to play a game to drill your statistical intuitions. The game works like this:
//
...
//     let leftMarbles = blueStart + redStart - bluePulled - redPulled
//     let leftBlue = blueStart - bluePulled
//     let result = ((100 / leftMarbles) * leftBlue) / 100
//     return result
// }
